<?php
   ...
   $sql = "Select Distinct rdept from report";
...
<head>
  ...
  <script type="text/javascript" src="js\ondept.js"></script>
        ...
        <div class="row">
          ...
          <div class="col-md-4">
            ...
            <label>Department</label>
              <select class="form-control" id="department" onchange = "selectV()" >
          ...
          <div class="col-md-4">
            <div class="form-group">
            <label>Dose</label>
              <select class="form-control" id="dose" onchange = "selectV()" >
