<?php
   ...
   $sql = "Select Distinct rvaccinactionname from report";
   $sql2="Select Distinct rdept from report";
   $sql3="Select Distinct dose from report";
   $sql4="Select Distinct ryear from report";
...
<nav class="navbar navbar-inverse">
  ...
  <div class="row content">
    <div class="col-sm-2 sidenav">
      ...
      <p><a href="ondose.php">Report on Dosewise</a></p>
        ...
        <div class="row">
          ...
          <div class="col-md-4">
            ...
            <label>Vaccine Name</label>
              <select class="form-control" id="vaccine" onchange="selectVD()">
              <option>Select Vaccine Name</option>
               <?php while( $rows = mysqli_fetch_array($res)){
                 ?>
                 <option value="<?php echo $rows['rvaccinactionname']; ?>" ><?php echo $rows['rvaccinactionname'];?></option>
                 <?php
               }
               ?>
              </select>
          ...
          <div class="col-md-4">
            ...
            <label>Department</label>
              <select class="form-control" id="department" onchange="selectVD()">
              <option>Select Department</option>
              <?php while( $rows = mysqli_fetch_array($res2)){
                 ?>
                
                 <option value="<?php echo $rows['rdept']; ?>" ><?php echo $rows['rdept'];?></option>
                 <?php
               }
               ?>
              </select>
